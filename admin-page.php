        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">
                      <li><h1 class="logo-wrapper"><a href="home.php" class="brand-logo darken-1"><img src="images/materialize-logo.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i>Our Menus</a>
            </li>
            ...
            <li class="bold"><a href="users.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Our Users</a>
            </li>
        </ul>
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Malvino's Food Menus	</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Add, Edit or Make Menus Unavailable.</p>
    ...
    $("#formValidate").validate({
        ...
        messages: {
			...
			while($row = mysqli_fetch_array($result))
			{
				...
				min: "Minimum item price is PHP 0"
				},';
			}
		echo '},';
		?>
    ...
    $("#formValidate1").validate({
		...
		name: {
		 ...
		 price: {
				...
				minlength: "Minimum item price is PHP 0"
			},
	},
		errorElement : 'div',
        errorPlacement: function(error, element) {
